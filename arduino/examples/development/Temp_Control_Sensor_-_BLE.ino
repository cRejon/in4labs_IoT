...
BLEIntCharacteristic tempCharacteristic("2A6E", BLERead | BLENotify);  // BLE Temperature Sensor Characteristic
BLEIntCharacteristic humCharacteristic("2A6F", BLERead | BLENotify);   // BLE Humidity Sensor Characteristic
...
void setup() {
  ...
  BLE.setLocalName("ArduinoDHT22Sensor");    // set the local name peripheral advertises
